<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Report_DailySalesReport2.aspx.cs" Inherits="Admin_Report_DailySalesReport2" %>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Labour Charges">
                                         ...
                                         <asp:TemplateField HeaderText="Dis.Labour Charges">
                                          ...
                                          <asp:TemplateField HeaderText="Service Tax 18%">
                                           <FooterTemplate>
                                         ...
                                         <asp:TemplateField HeaderText="SGST 14%">
                                           <FooterTemplate>
                                                 <asp:Label ID="lbl_fsgst14" runat="server" Font-Bold="True" ForeColor="Red" ></asp:Label>
                                             </FooterTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblfsgst14" runat="server" Text='<%# Eval("Dr_sgst14") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="90px" />
                                            <ItemStyle HorizontalAlign="Left" Width="90px" />
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="CGST 14%">
                                           <FooterTemplate>
                                                 <asp:Label ID="lbl_fcgst14" runat="server" Font-Bold="True" ForeColor="Red" ></asp:Label>
                                             </FooterTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblfcgst14" runat="server" Text='<%# Eval("Dr_cgst14") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="90px" />
                                            <ItemStyle HorizontalAlign="Left" Width="90px" />
                                        </asp:TemplateField>
                                         ...
                                         <asp:TemplateField HeaderText="IGST 28%">
                                           <FooterTemplate>
                                                 <asp:Label ID="lbl_figst28" runat="server" Font-Bold="True" ForeColor="Red" ></asp:Label>
                                             </FooterTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblfigst28" runat="server" Text='<%# Eval("Dr_Output13_5") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="90px" />
                                            <ItemStyle HorizontalAlign="Left" Width="90px" />
                                        </asp:TemplateField>
