<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Report_Vehicle_QuotationList.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
                                ...
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Model Sino">
                                            <ItemTemplate>
                                                <asp:Label ID="lblmsino0" runat="server" Text='<%# Eval("Vq_Id") %>'></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Quotation Code">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblpartyname" runat="server"  text='<%# Eval("Vq_PartyName") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                           ...
                                           <asp:TemplateField HeaderText="Vehicle Type">
                                            <ItemTemplate>
                                                <asp:Label ID="lblvehicletype" runat="server"  text='<%# Eval("Mv_VehicleType") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" Width="20%" />
                                        </asp:TemplateField>
                                          <asp:TemplateField HeaderText="Model Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblmodelname" runat="server"  text='<%# Eval("Mv_ModelName") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
