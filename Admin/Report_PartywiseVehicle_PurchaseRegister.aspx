<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Report_PartywiseVehicle_PurchaseRegister.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
...
<fieldset id="FS_IssuedBook" runat="server">
                    <legend>
                        <h4>
                            PartyWise Vehicle Purchase List </h4>
                    </legend>
                    ...
                    <td style="width: 1%">
                        :</td>
                    <td style="width: 24%">
                        <asp:DropDownList ID="ddl_BSuplier" runat="server" Width="150px">
                        </asp:DropDownList>
                    </td>
                    <td>
                        &nbsp;</td>
                         ...
                         <tr>
                             <td align="center" colspan="7" valign="top">
                                 ...
                                 <asp:Label ID="lbl_InvoiceType" runat="server" Font-Bold="True" 
                                     Font-Names="Cambria" Font-Size="16px">Party Wise Vehicle Purchase List</asp:Label>
                             </td>
                         </tr>
                         <tr>
                             <td align="center" colspan="7" valign="top">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Invoice No">
                                            <ItemTemplate>
                                                <asp:Label ID="Vp_Invoiceno" runat="server" Text='<%# Eval("Vp_Invoiceno") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Gross">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl004" runat="server" Text='<%# Eval("Vp_GrossAmount") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Discount">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl005" runat="server" Text='<%# Eval("Vp_Discount") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Gst">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl006" runat="server" Text='<%# Eval("Vp_VatAmount") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="CST">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl007" runat="server" Text='<%# Eval("Vp_CstAmount") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Other">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl009" runat="server" Text='<%# Eval("Vp_Other") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Bill Amount">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl010" runat="server" Text='<%# Eval("Vp_BillAmount") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
