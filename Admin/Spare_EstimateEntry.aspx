<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Spare_EstimateEntry.aspx.cs" Inherits="Admin_Spare_PurchaseEntry" %>
        ...
        <ContentTemplate>
            <div id="content" style="background-color: #FFFFFF; padding-left: 15px; padding-right: 10px;">
                <fieldset style="padding-right: 20px;">
                    <legend>
                        <h3>
                            Spare Part Estimation Entry</h3>
                    </legend>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt_PartDiscountper" runat="server" CssClass="TextBoxGraiant" Height="25px"
                                                ...
                                                ontextchanged="txt_PartDiscountper_TextChanged" AutoPostBack="True"></asp:TextBox>
                                        </td>
                                        <td>
