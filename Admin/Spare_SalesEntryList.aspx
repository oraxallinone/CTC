<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Spare_SalesEntryList.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="Panel1" runat="server">
                <fieldset id="FS_IssuedBook" runat="server">
                    ...
                    <tr>
                    <td>Finacial Year</td>
                    <td><asp:TextBox ID="txt_year" runat="server"></asp:TextBox>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Submitted By">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_submittedvy" runat="server" Text='<%# Eval("Submittedby") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left"  Width="100px" />
                                            <ItemStyle HorizontalAlign="Left"  Width="100px" />
                                        </asp:TemplateField>
