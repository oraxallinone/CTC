...
public partial class Report_ProjectExpensesDetailsCodeDatewise : System.Web.UI.Page
{
    ...
    public void fillgrid()
    {
        ...
        DataTable dtr = smitaDbAccess.SPReturnDataTable("Sp_JobcardSpareReturnlist", param, paramvalue);
        ...
        if (Convert.ToInt32(dtr.Rows.Count) > 0)
        {
            ...
            {
                Label lbljcardno = (Label)gr.FindControl("lbljcardno");
                Label lblcname = (Label)gr.FindControl("lblcname");
                Label lblengineno = (Label)gr.FindControl("lblengineno");
                Label lbldate = (Label)gr.FindControl("lbldate");

                int sino = Convert.ToInt32(lbljcardno.ToolTip);
                if (sino == 1)
                {
                    lbljcardno.Visible = true;
                    lblcname.Visible = true;
                    lblengineno.Visible = true;
                    lbldate.Visible = true;
                    lbljcardno.ForeColor = System.Drawing.Color.Red;
                    lblcname.ForeColor = System.Drawing.Color.Red;
                    lblengineno.ForeColor = System.Drawing.Color.Red;
                    lbldate.ForeColor = System.Drawing.Color.Red;
                }
                else
                {
                    lbljcardno.Visible = false;
