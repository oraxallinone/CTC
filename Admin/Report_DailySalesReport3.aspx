<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Report_DailySalesReport3.aspx.cs" Inherits="Admin_Report_DailySalesReport3" %>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Inv. Type">
                                         ...
                                         <asp:TemplateField HeaderText="Job Card No">
                                          ...
                                          <asp:TemplateField HeaderText="Jc Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lbldatejjcc" runat="server" Text='<%# Eval("JC_Date","{0:dd-MM-yyyy}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="80px" />
                                            <ItemStyle HorizontalAlign="Left" Width="80px" />
                                        </asp:TemplateField>
                                           ...
                                           <FooterTemplate>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblspare28" runat="server" 
                                                    Text='<%# Eval("SP_Amount_S28") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                        </asp:TemplateField>
                                           ...
                                           <FooterTemplate>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblspare18" runat="server" 
                                                    Text='<%# Eval("SP_Amount_S18") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                        </asp:TemplateField>
                                           ...
                                           <FooterTemplate>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lbllub28" runat="server" 
                                                    Text='<%# Eval("LU_Amount_S28") %>'></asp:Label>
                                            </ItemTemplate>
                                           ...
                                           <FooterTemplate>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lbllub18" runat="server" 
                                                    Text='<%# Eval("LU_Amount_S18") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                           ...
                                           <FooterTemplate>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lbldis28" runat="server" 
                                                    Text='<%# Eval("dis_Amount_S28") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Dis. 18%">
                                           <FooterTemplate>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lbldis18" runat="server" 
                                                    Text='<%# Eval("dis_Amount_S18") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                        </asp:TemplateField>
                                         ...
                                         <asp:TemplateField HeaderText="SP Output 28%">
                                           <FooterTemplate>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lbloutput28" runat="server" 
                                                    Text='<%# Eval("Spare_output28") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="SP Sgst 14%">
                                           <FooterTemplate>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblsgst" runat="server" 
                                                    Text='<%# Eval("spare_tax14") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="SP Cgst 14%">
                                           <FooterTemplate>
                                         ...
                                         <asp:TemplateField HeaderText="SP Igst 28%">
                                           <FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="SP OutPut 18%">
                                           <FooterTemplate>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblOutPut18" runat="server" 
                                                    Text='<%# Eval("Spare_output18") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                        </asp:TemplateField>

                                         <asp:TemplateField HeaderText="SP Sgst 9%">
                                           <FooterTemplate>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblsgst9" runat="server" 
                                                    Text='<%# Eval("spare_tax9") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                        </asp:TemplateField>
                                          <asp:TemplateField HeaderText="SP Cgst 9%">
                                           <FooterTemplate>
                                         ...
                                         <asp:TemplateField HeaderText="SP Igst 18%">
                                           <FooterTemplate>
                                         ...
                                         <asp:TemplateField HeaderText="LU Output 28%">
                                           <FooterTemplate>
                                                 <asp:Label ID="lbl_foutput28X" runat="server" Font-Bold="True" ForeColor="Red" ></asp:Label>
                                             </FooterTemplate>
                                            <ItemTemplate>
                                          
                                                <asp:Label ID="lbloutput28X" runat="server" 
                                                    Text='<%# Eval("Lubri_Output28") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="LU Sgst 14%">
                                           <FooterTemplate>
                                                 <asp:Label ID="lbl_sgst14X" runat="server" Font-Bold="True" ForeColor="Red" ></asp:Label>
                                             </FooterTemplate>
                                            <ItemTemplate>
                                          
                                                <asp:Label ID="lblsgstX" runat="server" 
                                                    Text='<%# Eval("lubri_tax14") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="LU Cgst 14%">
                                           <FooterTemplate>
                                                 <asp:Label ID="lbl_cgst14X" runat="server" Font-Bold="True" ForeColor="Red" ></asp:Label>
                                             </FooterTemplate>
                                            <ItemTemplate>
                                          
                                                <asp:Label ID="lblcgstX" runat="server" 
                                                    Text='<%# Eval("lubri_tax14") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                         ...
                                         <asp:TemplateField HeaderText="LU Igst 28%">
                                           <FooterTemplate>
                                                 <asp:Label ID="lbl_igst28X" runat="server" Font-Bold="True" ForeColor="Red" ></asp:Label>
                                             </FooterTemplate>
                                            <ItemTemplate>
                                          
                                                <asp:Label ID="lbligstX" runat="server" 
                                                    Text='<%# Eval("Lubri_Output28") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                        ...
                                        <asp:TemplateField HeaderText="LU OutPut 18%">
                                           <FooterTemplate>
                                                 <asp:Label ID="lbl_OutPut18X" runat="server" Font-Bold="True" ForeColor="Red" ></asp:Label>
                                             </FooterTemplate>
                                            <ItemTemplate>
                                          
                                                <asp:Label ID="lblOutPut18X" runat="server" 
                                                    Text='<%# Eval("Lubri_Output18") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                        </asp:TemplateField>

                                         <asp:TemplateField HeaderText="LU Sgst 9%">
                                           <FooterTemplate>
                                                 <asp:Label ID="lbl_sgst9X" runat="server" Font-Bold="True" ForeColor="Red" ></asp:Label>
                                             </FooterTemplate>
                                            <ItemTemplate>
                                          
                                                <asp:Label ID="lblsgst9X" runat="server" 
                                                    Text='<%# Eval("lubri_tax9") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                        </asp:TemplateField>
                                          <asp:TemplateField HeaderText="LU Cgst 9%">
                                           <FooterTemplate>
                                                 <asp:Label ID="lbl_cgst9X" runat="server" Font-Bold="True" ForeColor="Red" ></asp:Label>
                                             </FooterTemplate>
                                            <ItemTemplate>
                                          
                                                <asp:Label ID="lblcgst9X" runat="server" 
                                                    Text='<%# Eval("lubri_tax9") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                         ...
                                         <asp:TemplateField HeaderText="LU Igst 18%">
                                           <FooterTemplate>
                                                 <asp:Label ID="lbl_igst18X" runat="server" Font-Bold="True" ForeColor="Red" ></asp:Label>
                                             </FooterTemplate>
                                            <ItemTemplate>
                                          
                                                <asp:Label ID="lbligst18X" runat="server" 
                                                    Text='<%# Eval("Lubri_Output18") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                       ...
                                       <asp:TemplateField HeaderText="Net Labour Charges" >
                                         ...
                                         <asp:TemplateField HeaderText="SGST 9%">
                                           <FooterTemplate>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblfsgst9" runat="server" Text='<%# Eval("st_9") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="90px" />
                                            <ItemStyle HorizontalAlign="Left" Width="90px" />
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="CGST 9%">
                                           <FooterTemplate>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblfcgst9" runat="server" Text='<%# Eval("st_9") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="90px" />
                                            <ItemStyle HorizontalAlign="Left" Width="90px" />
                                        </asp:TemplateField>
