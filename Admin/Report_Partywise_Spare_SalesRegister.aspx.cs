...
public partial class Report_ProjectExpensesDetailsCodeDatewise : System.Web.UI.Page
{
    ...
    private void FillCustomer()
    {
        ...
        ddlcustomer.DataSource = v.ToList();
        ddlcustomer.DataTextField = "Su_Name";
        ddlcustomer.DataValueField = "Su_Code";
    ...
    public void FillGrid()
    {
        ...
        string paramvalue = Convert.ToDateTime(txt_FromDate.Text, SmitaClass.dateformat()).ToString("yyyy-MM-dd HH:mm:ss") + " , " + Convert.ToDateTime(txt_ToDate.Text, SmitaClass.dateformat()).ToString("yyyy-MM-dd HH:mm:ss") + "," + Branch+","+ddlcustomer.SelectedValue;
