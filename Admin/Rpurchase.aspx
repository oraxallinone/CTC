<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Rpurchase.aspx.cs" Inherits="Admin_Rpurchase" %>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    <Columns>
                                      ...
                                      <%-- <FooterTemplate>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblvat14" runat="server" Text='<%# Eval("Ss_Vat14") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                       ...
                                       <%-- <FooterTemplate>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblvat5" runat="server" Text='<%# Eval("Ss_Vat5") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        ...
                                        <%--<FooterTemplate>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblvat2" runat="server" Text='<%# Eval("Ss_Vat2") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
