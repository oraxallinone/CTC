<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Service_JobcardSpareReturn_List.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
...
<fieldset id="FS_IssuedBook" runat="server">
                    <legend>
                        <h4>
                            Job Card SpareReturn Report&nbsp; List Datewise</h4>
                    </legend>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Jobcard No">
                                            <ItemTemplate>
                                                <asp:Label ID="lbljcardno" runat="server" Text='<%# Eval("JC_No") %>' ToolTip='<%# Eval("sino") %>'></asp:Label>
                                            </ItemTemplate>
                                          ...
                                          <asp:TemplateField HeaderText="Engine No">
                                            <ItemTemplate>
                                                <asp:Label ID="lblengineno" runat="server" 
                                                    text='<%# Eval("JC_Engineno") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblreturnquntity" runat="server"  text='<%# Eval("SR_returnquantity") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Return date">
                                            <ItemTemplate>
                                                <asp:Label ID="lbldate" runat="server" 
                                                    Text='<%# Eval("SE_ReturnDate","{0:dd/MM/yyyy}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                  ...
                                  <%--      <asp:TemplateField HeaderText="View" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgbtnview" runat="server" ToolTip='<%# Eval("SR_Id") %>'
                                    ...
                                    <%--    <asp:TemplateField HeaderText="Edit">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgbtnedit" runat="server" ToolTip='<%# Eval("SR_Id") %>'
                                  ...
                                  <%--      <asp:TemplateField HeaderText="Delete" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgbtndelete" runat="server" ToolTip='<%# Eval("SR_Id") %>'
