<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Service_JobFinalInvoice.aspx.cs" Inherits="Admin_Spare_PurchaseEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
 ...
 <script type="text/javascript">
     function validationfields() {
         ...
         if (document.getElementById('ContentPlaceHolder1_txt_serialno').value == "") {
             alert("Date Should Not Blank");
            
             return false;
         }
         if (document.getElementById('ContentPlaceHolder1_txt_invno').value == "") {
             alert("Invoice No Should Not Blank");

             return false;
         }
         if (document.getElementById('ContentPlaceHolder1_txt_invdate').value == "") {
             alert("Date Should Not Blank");

             return false;
         }
         if (document.getElementById('ContentPlaceHolder1_txt_jcno').value == "") {
             alert("JC No Should Not Blank");

             return false;
         }
         if (document.getElementById('ContentPlaceHolder1_txt_RegdNo').value == "") {
             alert("Registred No Should Not Blank");

             return false;
         }
         if (document.getElementById('ContentPlaceHolder1_txt_model').value == "") {
             alert("Model No Should Not Blank");

             return false; 
         }
         if (document.getElementById('ContentPlaceHolder1_txt_mobno').value == "") {
         ...
         if (document.getElementById('ContentPlaceHolder1_txt_SGrossAmount').value == "") {
             alert("Gross amount Should Not Blank");

             return false;
         }
         if (document.getElementById('ContentPlaceHolder1_txt_SerDiscountAmount').value == "") {
             alert("Discount Amount Should Not Be Blank..");

             return false;
         }

         if (document.getElementById('ContentPlaceHolder1_txt_StotalAmount').value == "") {
             alert("Net Amount Should Not Be Blank..!!.");

             return false;
         }
         if (document.getElementById('ContentPlaceHolder1_txt_SVatAmount').value == "") {
             alert("Vat Amount Should Not Be Blank..!!");

             return false;
         }
         if (document.getElementById('ContentPlaceHolder1_txt_LabourCharges').value == "") {
             alert("LabourChargs Should Not Be Blank..!!");

             return false;
         }

         if (document.getElementById('ContentPlaceHolder1_txt_LabDiscountPer').value == "") {
             alert("labour DiscountPercentage Should Not Be Blank..!!");
         ...
         if (document.getElementById('ContentPlaceHolder1_txt_submittedby').value == "") {
             alert("Please Enter your name..!!");

             document.getElementById('ContentPlaceHolder1_txt_submittedby').focus();
         ...
         if (document.getElementById('ContentPlaceHolder1_txt_ServiceTaxAmt').value == "") {
             alert("labour ServiceTax Should Not Be Blank..!!");
     ...
     function discc() {
         ...
         var rate = document.getElementById('ContentPlaceHolder1_txt_SGrossAmount');
         var discount = document.getElementById('ContentPlaceHolder1_txt_SDiscountPer');
         var discountamnt = document.getElementById('ContentPlaceHolder1_txt_SerDiscountAmount');
         var x = parseFloat(rate.value);
         var y = discount.value;
         var z = y / 100;
         var b=parseFloat(x*z);
         document.getElementById('ContentPlaceHolder1_txt_SerDiscountAmount').value = Math.round(x * z);
         var amnt = document.getElementById('ContentPlaceHolder1_txt_SerDiscountAmount');
         var p =parseFloat(amnt.value);
         document.getElementById('ContentPlaceHolder1_txt_StotalAmount').value = Math.round(x - p);
     }
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div id="content" style="background-color: #FFFFFF; padding-left: 15px; padding-right: 10px;">
                <fieldset style="padding-right: 20px;">
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td class="style7">
                                :</td>
                            <td class="style7" style="position:relative">
                        ...
                        <tr>
                            ...
                            <td class="ui-priority-primary">
                                :</td>
                            <td>
                                <asp:TextBox ID="txt_submittedby" runat="server"   CssClass="TextBoxGraiant" 
                                    Height="25px" Width="200px"></asp:TextBox>
                ...
                <ItemTemplate>
                    <asp:Label ID="Labelhsncode" runat="server" Text='07080000'></asp:Label>
                </ItemTemplate>
                ...
                <ItemStyle HorizontalAlign="Left" Width="150px" />
                                        ...
                                        <asp:TemplateField HeaderText="Category">
                                            <ItemTemplate>
                                                <asp:Label ID="lblcategory" runat="server" Text='<%# Eval("Itm_CategoryName") %>' ></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="150px" />
                                            <ItemStyle HorizontalAlign="Left" Width="150px" />
                                        </asp:TemplateField>
                                ...
                                <table class="skin-3" id="tbl_service" runat="server"
                                    ...
                                    <tr bgcolor="#6fb3e0">
                                        ...
                                        <td class="ui-priority-primary">
                                            Rate</td>
                                               <td class="ui-priority-primary">
                                            Dis%</td>   <td class="ui-priority-primary">
                                            DisAmt</td>
                                    ...
                                    <asp:ListItem>FOC</asp:ListItem>
                                        ...
                                        <td class="style2">
                                            <asp:TextBox ID="txt_discamu" ReadOnly="true" runat="server" CssClass="SmalldottedTextBox" 
                                                onkeypress="return AllowDecimalNumbersOnly(this,event)" Width="50px"></asp:TextBox>
                                        </td>
            ...
            <asp:TemplateField HeaderText="HSN Code">
                <ItemTemplate>
                    <asp:Label ID="Labelhsncode" runat="server" Text='00440181'></asp:Label>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Dis%">
                <ItemTemplate>
                    <asp:TextBox ID="Labels55" runat="server" Text='<%# Eval("JCS_Disper") %>' AutoPostBack="True"  ToolTip='<%# Eval("JCS_Sino") %>' ReadOnly="True" OnTextChanged="Labels55_TextChanged" ></asp:TextBox>
                </ItemTemplate>
                <HeaderStyle HorizontalAlign="Left" Width="50px" />
                <ItemStyle HorizontalAlign="Left" Width="50px" />
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="DisAmt.">
                <ItemTemplate>
                    <asp:Label ID="Labels56" ReadOnly="true" runat="server" Text='<%# Eval("JCS_DisAmu") %>' ></asp:Label>
                </ItemTemplate>
                <HeaderStyle HorizontalAlign="Left" Width="50px" />
                <ItemStyle HorizontalAlign="Left" Width="50px" />
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Amount">
                ...
                <ItemTemplate>
                    ...
                    <asp:TextBox ID="Labels6" ReadOnly="true" runat="server" Text='<%# Eval("JCS_Amount") %>' style="border:0px"
                        ></asp:TextBox>
                </ItemTemplate>
                <HeaderStyle HorizontalAlign="Left" Width="80px" />
                <ItemStyle HorizontalAlign="Left" Width="80px" />
                    ...
                    <asp:Label ID="lbledit" runat="server" Font-Bold="True"></asp:Label>
                                  ...
                                  <ItemTemplate>
                                      <asp:ImageButton ID="ImageButton1" runat="server" Height="20px" 
                                         ToolTip='<%# Eval("JCS_Sino") %>' ImageUrl="~/Admin/Images/edit-icon.png" onclick="ImageButton1_Click" />
                                      <asp:ImageButton ID="ImageButton2" runat="server" Height="20px" 
                                         ToolTip='<%# Eval("JCS_Sino") %>' ImageUrl="~/Admin/Images/UPDATE (1).png" onclick="ImageButton2_Click" 
                                          Visible="False" />
                                  </ItemTemplate>
                <HeaderStyle HorizontalAlign="Left" Width="50px" />
                <ItemStyle HorizontalAlign="Left" Width="50px" />
             ...
             <asp:TemplateField HeaderText="Delete">
                                  ...
                                  <ItemTemplate>
                                      <asp:ImageButton ID="img_del" runat="server" Height="20px" 
                                         ToolTip='<%# Eval("JCS_Sino") %>' ImageUrl="~/Admin/Images/Delete_Icon.png" 
                                          onclick="img_del_Click"  />
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="style9">
                                <asp:CheckBox ID="CheckBox1" runat="server" Text="Add Tax" 
                                 Enabled="false"    AutoPostBack="True" oncheckedchanged="CheckBox1_CheckedChanged" 
                                    Checked="True" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <asp:Button ID="btn_Submit" runat="server" CssClass="VerySmallGreen" Height="26px"
                                   OnClientClick="return validationfields();" Text="Submit" Width="120px" onclick="btn_Submit_Click"  />
                            </td>
                            <td align="right">
                                &nbsp;</td>
                            <td>
