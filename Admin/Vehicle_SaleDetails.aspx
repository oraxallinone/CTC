<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Vehicle_SaleDetails.aspx.cs" Inherits="Admin_Spare_PurchaseEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div id="content" style="background-color: #FFFFFF; padding-left: 15px; padding-right: 10px;">
                <fieldset style="padding-right: 20px;">
                    ...
                    <table width="100%">
                    <tr>
                    <td align="center" >Bill&nbsp; No :<asp:TextBox ID="txt_billno" runat="server" 
                            AutoPostBack="True" CssClass="TextBoxGraiant" Height="25px" 
                            ontextchanged="txt_billno_TextChanged" Width="200px"></asp:TextBox>
                        </td>
                  
                    </tr>
                
                    </table>
                    <table id="tbl_details" runat="server" style="width: 100% ; ">
                        <tr>
                            <td style="width: 15%">
                                Bill NO</td>
                            <td style="width: 1%">
                            ...
                            <td>
                                <asp:DropDownList ID="ddl_invtype" runat="server" Width="200px">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txt_billdate" runat="server" CssClass="TextBoxGraiantDate" 
                                    Height="25px" Width="200px" TextMode="MultiLine"></asp:TextBox>
                        ...
                        <tr>
                          ...
                          <tr>
                              ...
                              <td>
                                  ;</td>
                              <td>
                                  <asp:TextBox ID="txt_mfdate" runat="server" CssClass="TextBoxGraiantDate" 
                                      Height="25px" Width="200px"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txt_Quantity" runat="server" CssClass="SmalldottedTextBox" 
                                    Height="25px" onkeypress="return AllowDecimalNumbersOnly(this,event)" 
                                    Width="200px" AutoPostBack="True" ontextchanged="txt_Quantity_TextChanged">0</asp:TextBox>
                            </td>
                            <td width="20%">
                                Amount</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txt_GrossAmount" runat="server" CssClass="TextBoxGraiant" Height="25px"
                                    Width="160px"  
                        ...
                        <tr>
                            ...
                            <td align="right" class="style4">
                                <asp:Button ID="btn_challan" runat="server" CssClass="VerySmallGreen" Height="26px"
                                    Text="Challan" Width="120px" onclick="btn_challan_Click"  OnClientClick ="document.forms[0].target = '_blank';" />
                            </td>
                            <td align="right" class="style4">
                            </td>
                            <td class="style4">
                            ...
                            <td class="style4">
                                &nbsp;
                                <asp:Button ID="btn_form21" runat="server" CssClass="thinCupersulphate" 
                                    Height="26px"  Text="Form 21" Width="120px" onclick="btn_form21_Click"  OnClientClick ="document.forms[0].target = '_blank';" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6" align="center">
                                ...
                                <asp:Button ID="btnprint" runat="server" CssClass="btn-info" Font-Bold="True" 
                                    Font-Names="US"  Text="BillPrint" onclick="btnprint_Click" OnClientClick ="document.forms[0].target = '_blank';" />
                            </td>
                        </tr>
                    </table>
                </fieldset>
