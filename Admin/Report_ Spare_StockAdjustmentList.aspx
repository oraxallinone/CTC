<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Report_ Spare_StockAdjustmentList.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
...
<fieldset id="FS_IssuedBook" runat="server">
        ...
        <asp:Label ID="lbl_BranchAddress" runat="server" Font-Bold="False" 
            Font-Names="Cambria"></asp:Label>
                                            ,<asp:Label ID="lbltinno" runat="server" Font-Bold="False" Font-Names="Cambria"></asp:Label>
        <br />
                                    ...
                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                                       Font-Names="Vani" Font-Size="12px" Width="100%" BorderColor="#44C767" 
                                        ...
                                        <Columns>
                                          <asp:TemplateField HeaderText="Sl. No.">
                                            ...
                                            <asp:TemplateField HeaderText="Amount">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbladjustquantity" runat="server" 
                                                        Text='<%# Eval("SSA_Adjustquantity") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                                            </asp:TemplateField>
                                        ...
                                        <HeaderStyle Font-Names="Cambria" Font-Size="14px" Font-Bold="True" 
                                            BackColor="#DF5015" ForeColor="White" HorizontalAlign="Left" />
                                    </asp:GridView>
                                </td>
                            </tr>
                    </table>
