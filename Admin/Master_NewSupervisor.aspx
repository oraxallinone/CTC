<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Master_NewSupervisor.aspx.cs" Inherits="Admin_CreateUser" %>
                ...
                <fieldset style="padding-right: 20px;">
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td class="style1">
                                <strong>Supervisor List</strong></td>
                        </tr>
                        <tr>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Supervisor Name">
                                            <ItemTemplate>
                                                <asp:Label ID="Label3" runat="server" Text='<%# Eval("Ms_Name") %>'></asp:Label>
                                            </ItemTemplate>
