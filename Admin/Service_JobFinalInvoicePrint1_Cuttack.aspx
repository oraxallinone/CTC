<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Service_JobFinalInvoicePrint1_Cuttack.aspx.cs" Inherits="Admin_Service_JobFinalInvoicePrint1_Cuttack" %>
...
<td align="center" 
        colspan="9">
    Authorised Main Dealer Of Ashok Leyland Light Vehicle</td>
</tr>
        <tr>
        ...
        <tr>
            <td align="center" colspan="9" style="text-transform:lowercase;">
                E-mail : rashmimotors.lcv@rashmigroups.com, Mobile-0671-2393575</td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center" colspan="9" 
                ...
                style="font-size: small; color: #000000; font-weight: bold; border-bottom-style: dashed; border-bottom-width: thin; border-bottom-color: #000000;">
        ...
        <%--<tr>
            <td align="center" class="style1" colspan="9" 
                style="color: #000000; font-weight: bold; font-size: small">
                &nbsp;</td>
        </tr>--%>
        <tr>
            <td align="left" 
        ...
        <tr>
            ...
            <td align="left">
                <asp:Label ID="lbl_supp" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="left" width="20%">
        ...
        <tr>
            ...
            <td align="center" colspan="9" 
                style="font-size:small; color: #000000; font-weight: bold;">
                SPARE DETAILS</td>
        ...
        <tr>
            <td align="left" class="style1" colspan="9" >
                <asp:GridView ID="grd_service" runat="server" AutoGenerateColumns="False" 
                    style="font-size:10px; font-family:Arial;" ShowFooter="True" Width="100%">
                    <Columns>
    ...
    <tr>
        ...
        <%--<tr>
            <td align="right" colspan="4">
                &nbsp;</td>
            <td align="left" colspan="2">
                 Tax @<asp:Label ID="lblservtaxp" runat="server" Text="18"></asp:Label>
                &nbsp;%</td>
            <td align="right" colspan="2">
    ...
    <td align="left" colspan="5" 
        ...
        <tr>
            <td align="left" colspan="9" 
                ...
                style="font-size:small; color: #000000; font-weight: bold; text-decoration: underline; border-bottom-style: dotted; border-bottom-width: thin; border-bottom-color: #000000;" 
                class="style2">
                TERMS &amp; CONDITIONS :</td>
        </tr>
        <tr>
            <td align="left" style="font-size:10px; " colspan="9">
        ...
        <tr>
            <td align="left" colspan="9" style="font-size: medium; text-decoration: underline; border-bottom-style: dotted; border-bottom-width: thin; border-bottom-color: #000000; ">
                &nbsp;</td>
        </tr>
         <tr>
            <td align="center" colspan="9" 
                
                style="font-size: medium; color: #000000; font-weight: bold; text-decoration: underline; border-bottom-style: dotted; border-bottom-width:medium; border-bottom-color: #000000;" 
                class="style2">
