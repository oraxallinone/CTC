...
using System.Text;
using System.IO;
public partial class Admin_Report_CounterSale2 : System.Web.UI.Page
{
    ...
    tot20 = 0, tot21 = 0, tot22 = 0, tot23 = 0, tot26 = 0, tot27 = 0, tot24 = 0, tot25 = 0, tot100 = 0;
    ...
    public void FillGrid()
    {
        try
        {
            ...
            DataTable dtr = smitaDbAccess.SPReturnDataTable("sp_CounterSale_WithReturn_Reportgst1", param, paramvalue);
            if (dtr.Rows.Count > 0)
            {
                ...
                foreach (GridViewRow gr in GridView1.Rows)
                {
                    ...
                    Label lblpak = (Label)gr.FindControl("lblpking");
                    decimal pak = Convert.ToDecimal(lblpak.Text == "" ? "0.00" : lblpak.Text);
                    ...
                    //lblspare28.Text = (spare28 - dis28).ToString("0.00");
                    ...
                    Label lbl_fpak = (Label)GridView1.FooterRow.FindControl("lbl_paking");
                    lbl_fpak.Text = tot100.ToString("0.00");
    ...
    protected void btn_excel_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string Branch = Session["Branch"].ToString();
            string attachment = "attachment; filename=" + "DailyCounterSalesReport" + "(" + Branch + ")" + ".xls";
