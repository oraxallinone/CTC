<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Service_JobPerformaInvoicePrint_Phulnakhara.aspx.cs" Inherits="Admin_Service_JobPerformaInvoicePrint_Phulnakhara" %>
...
<td align="left" 
    ...
    <asp:GridView ID="grd_spare" runat="server" AutoGenerateColumns="False" 
        style="font-size:12px; font-family:Arial;" ForeColor="Black">
