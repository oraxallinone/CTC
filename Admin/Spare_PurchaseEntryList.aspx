<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Spare_PurchaseEntryList.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
                ...
                <fieldset id="FS_IssuedBook" runat="server">
                    ...
                    <tr>
                           ...
                           Finacial Year
                            ...
                            <td style="width: 24%">
                                <asp:TextBox ID="txt_jcyear" runat="server" Width="130px"></asp:TextBox>
