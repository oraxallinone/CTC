<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Vehicle_SaleReturn.aspx.cs" Inherits="Admin_Spare_PurchaseEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
     ...
     <script type="text/javascript">
         function PrintPanel() {
             var panel = document.getElementById("<%=display.ClientID %>");
                    ...
                    <table id="tbl_details" runat="server" style="width: 100% ; ">
                        ...
                        <tr>
                            ...
                            <td align="right" class="style4">
                                &nbsp;</td>
                            <td align="right" class="style4">
                                <asp:Button ID="btn_salereturn" runat="server" CssClass="VerySmallGreen" 
                                    Height="26px"  Text="Sales Return" Width="120px" 
                                    onclick="btn_salereturn_Click" />
                            </td>
                            <td class="style4">
                                &nbsp;
                            </td>
