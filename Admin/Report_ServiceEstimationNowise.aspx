<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Report_ServiceEstimationNowise.aspx.cs" Inherits="Admin_ServiceEstimation" %>
...
<asp:Label ID="lbl_Header" runat="server" CssClass="Header1" Text="Job Estimation  Report">
 ...
 <fieldset style="text-transform:uppercase;">
       ...
       <br /> 
        &nbsp;<center>
        <table style="width:210mm; text-transform:uppercase;">
        <tr>
        <td width="25%">
        </td>
        <td width="20%" align="right">
            Enter Estimation No</td>
        <td width="3%">
            :</td>
        <td width="25%" align="left">
            <asp:TextBox ID="txt_estimationno" runat="server" Width="200px"></asp:TextBox>
        </td>
         <td width="2">
        </td>
        <td align="right">
