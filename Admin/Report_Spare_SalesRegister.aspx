<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Report_Spare_SalesRegister.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
                        ...
                        <tr>
                            <td align="center" valign="top">
                                ...
                                <asp:Label ID="lbl_InvoiceType" runat="server" Font-Bold="True" 
                                    Font-Names="Cambria" Font-Size="16px">SPARE SALES LIST</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" valign="top">
