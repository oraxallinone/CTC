...
public partial class Admin_Service_JobFinalInvoicePrint1_Cuttack : System.Web.UI.Page
{
    ...
    public void fillEdit()
    {
        try
        {
            ...
            var v = (from c in db.AME_Service_JobcardSpareIssue
                     ...
                     where c.JC_No == sino && c.Branch_Name == branchname && c.SE_Quantity > 0 && c.Jc_year == year && g.Branch_Name==branchname
                     select new

                     {
                         ...
                         // SE_Sgst=(c.SE_Taxamount/2).ToString("0.00"),
    ...
    public void fillservice()
    {
        try
        {
            ...
            var v = (from c in db.AME_Service_JobCardEntry
                     ...
                     where c.JC_No == sino && c.Branch_Name == branchname && c.JC_year == year && g.Jc_year == year && g.Branch_Name == branchname && s.Branch_Name==branchname
                     select new
    ...
    public void fillservicedetails()
    {
        try
        {
            ...
            lbl_supp.Text = v.First().placeofsupp;
