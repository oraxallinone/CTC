...
using System.Text;
using System.IO;
public partial class Admin_Report_DailySalesReport1 : System.Web.UI.Page
{
    ...
    decimal tot1 = 0, tot2 = 0, tot3 = 0, tot4 = 0, tot5 = 0, tot6 = 0, tot7 = 0, tot8 = 0,
       tot9 = 0, tot10 = 0, tot11 = 0, tot12 = 0, tot13 = 0, tot14 = 0, tot15 = 0, tot16 = 0, tot17 = 0, tot18 = 0, tot19 = 0, tot20 = 0, tot21 = 0, tot22 = 0, tot23 = 0;
    ...
    public void FillGrid()
    {
        try
        {
            ...
            DataTable dtr = smitaDbAccess.SPReturnDataTable("sp_DailySpareSales_WithReturn_Report3", param, paramvalue);
            if (dtr.Rows.Count > 0)
            {
                ...
                foreach (GridViewRow gr in GridView1.Rows)
                {
                    ...
                    decimal outsidejob = Convert.ToDecimal(lbloutsidejob.Text == "" ? "0.00" : lbloutsidejob.Text);
                    ...
                    decimal servtax12 = Convert.ToDecimal(lblservtax12.Text == "" ? "0.00" : lblservtax12.Text);
                    Label lblnetlbrchrg = (Label)gr.FindControl("lblnetlbrchrg");
                    decimal netlbrchrg = Convert.ToDecimal(lblnetlbrchrg.Text == "" ? "0.00" : lblnetlbrchrg.Text);
                    Label lbldiscountlbrcharge = (Label)gr.FindControl("lbldiscountlbrcharge");
                    decimal discountlbrcharge = Convert.ToDecimal(lbldiscountlbrcharge.Text == "" ? "0.00" : lbldiscountlbrcharge.Text);
                    Label lbllabourcharges = (Label)gr.FindControl("lbllabourcharges");
                    decimal labourcharges = Convert.ToDecimal(lbllabourcharges.Text == "" ? "0.00" : lbllabourcharges.Text);
                    Label lblotherchrges = (Label)gr.FindControl("lblotherchrges");
                    decimal otherchrges = Convert.ToDecimal(lblotherchrges.Text == "" ? "0.00" : lblotherchrges.Text);
                    Label lbloutput5 = (Label)gr.FindControl("lbloutput5");
                    decimal output5 = Convert.ToDecimal(lbloutput5.Text.Trim() == "" ? "0.00" : lbloutput5.Text);
                    Label lbloutput135 = (Label)gr.FindControl("lbloutput135");
                    decimal output135 = Convert.ToDecimal(lbloutput135.Text == "" ? "0.00" : lbloutput135.Text);
                    Label lbldiscount = (Label)gr.FindControl("lbldiscount");
                    decimal discount = Convert.ToDecimal(lbldiscount.Text == "" ? "0.00" : lbldiscount.Text);
                    Label lbldis135 = (Label)gr.FindControl("lbldis135");
                    decimal dis135 = Convert.ToDecimal(lbldis135.Text == "" ? "0.00" : lbldis135.Text);
                    Label lbllub5 = (Label)gr.FindControl("lbllub5");
                    decimal lub5 = Convert.ToDecimal(lbllub5.Text == "" ? "0.00" : lbllub5.Text);
                    Label lbllub135 = (Label)gr.FindControl("lbllub135");
                    decimal lub135 = Convert.ToDecimal(lbllub135.Text == "" ? "0.00" : lbllub135.Text);
                    Label lblspare5 = (Label)gr.FindControl("lblspare5");
                    decimal spare5 = Convert.ToDecimal(lblspare5.Text == "" ? "0.00" : lblspare5.Text);

                    Label lblspare135 = (Label)gr.FindControl("lblspare135");

                    decimal spare135 = Convert.ToDecimal(lblspare135.Text == "" ? "0.00" : lblspare135.Text);
                    ...
                    double output14 = Convert.ToDouble(lblout14.Text == "" ? "0.00" : lblout14.Text);


                    Label lbllub14 = (Label)gr.FindControl("lbllub135");
                    // decimal outputlub14 = Convert.ToDecimal(lbllub14.Text);

                    double outputlub14 = Convert.ToDouble(lbllub14.Text == "" ? "0.00" : lbllub14.Text);


                    Label lblout5 = (Label)gr.FindControl("lblspare5");
                    // decimal outputot5 = Convert.ToDecimal(lblout5.Text);
                    double outputot5 = Convert.ToDouble(lblout5.Text == "" ? "0.00" : lblspare5.Text);


                    Label lbloutlub5 = (Label)gr.FindControl("lbllub5");
                    //  decimal outputlub5 = Convert.ToDecimal(lbloutlub5.Text);
                    double outputlub5 = Convert.ToDouble(lbloutlub5.Text == "" ? "0.00" : lbloutlub5.Text);


                    Label lblnetlbrchrg1 = (Label)gr.FindControl("lblnetlbrchrg");
                    double netlbrchrg1 = Convert.ToDouble(lblnetlbrchrg1.Text == "" ? "0.00" : lblnetlbrchrg1.Text);


                    Label lblservtax121 = (Label)gr.FindControl("lblservtax12");
                    double servtax121 = Convert.ToDouble(lblservtax121.Text == "" ? "0.00" : lblservtax121.Text);


                    Label lblamount0 = (Label)gr.FindControl("lblinvoicetotal");
                    double gamnt = Convert.ToDouble(lblamount0.Text == "" ? "0.00" : lblamount0.Text);


                    Label lblroundoff1 = (Label)gr.FindControl("lblroundoff");
                    double roundoff1 = Convert.ToDouble(lblroundoff1.Text == "" ? "0.00" : lblroundoff1.Text);
                    ...
                    tot34 = netlbrchrg1;
                    tot35 = servtax121;
                    //  lbloutput135.Text = Math.Round(tot24,2).ToString("0.00");
                    tot39 = Math.Round(tot24, 2);

                    //lbloutput135.Text = Convert.ToDouble(tot24 * 0.145).ToString("0.00");
                    //  lbloutput5.Text = Convert.ToDouble(tot25 * 0.145).ToString("0.00");
                    ...
                    tot32 = tot32 + gamnt;
                    // tot32 = tot32 + (tot24 + tot25 + tot28 + tot29 + tot30 + tot31);

                  //  tot32 = tot32 + (Convert.ToDouble(output135) + Convert.ToDouble(output5) + tot34 + tot35 + outputlub14 + output14 + outputot5 + outputlub5);

                   
                    // tot33 = tot39 + tot25 + tot34 + tot35 + tot30 + tot31;

                  //  tot33 = Convert.ToDouble(output135) + tot25 + tot34 + tot35 + tot30 + tot31;
                    tot33 = Convert.ToDouble(output135) + Convert.ToDouble(output5) + tot34 + tot35 + tot30 + tot31;

                   // lblamount0.Text = Math.Round(tot33).ToString("0.00");

                    tot36 = Math.Round(tot33);
                  ...
                  //  tot36 = Convert.ToDouble(lblamount0.Text);
                    ...
                    // tot22 = Convert.ToDecimal( tot22 + lbloutput135.Text);
                    //tot23 = tot23 + tot21;

                    // tot23 = Convert.ToDecimal( tot23 + lbloutput5.Text;
