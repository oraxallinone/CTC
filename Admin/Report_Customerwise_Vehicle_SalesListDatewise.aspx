<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Report_Customerwise_Vehicle_SalesListDatewise.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
...
<fieldset id="FS_IssuedBook" runat="server">
                    <legend>
                        <h4>
                            CustomerWise Vehicle Sale List </h4>
                    </legend>
                    ...
                    <td style="width: 24%">
                        &nbsp;</td>
                    <td style="width: 16%">
                        Select Customer Name</td>
                    <td style="width: 1%">
                        :</td>
                    <td style="width: 24%">
                        <asp:DropDownList ID="ddl_customer" runat="server" AppendDataBoundItems="True" 
                            Width="170px">
                        </asp:DropDownList>
                    </td>
                    <td>
                         ...
                         <tr>
                             <td align="center" colspan="7" valign="top">
                                 ...
                                 <asp:Label ID="lbl_InvoiceType" runat="server" Font-Bold="True" 
                                     Font-Names="Cambria" Font-Size="16px">CustomerWiseVehicleSaleList</asp:Label>
                             </td>
                         </tr>
                         <tr>
                             <td align="center" colspan="7" valign="top">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Invoice Type">
                                         ...
                                         <asp:TemplateField HeaderText="Bill No">
                                            <ItemTemplate>
                                                <asp:Label ID="lblbillno" runat="server" Text='<%# Eval("Vs_Billno") %>' 
                                        ...
                                        <asp:TemplateField HeaderText="Party Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblpartyname" runat="server" Text='<%# Eval("Mc_Name") %>' 
                                        ...
                                        <asp:TemplateField HeaderText="Bill date">
                                            <ItemTemplate>
                                                <asp:Label ID="lbldate" runat="server" 
                                                    Text='<%# Eval("Vs_Billdate","{0:dd/MM/yyyy}") %>' Width="100px"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                       ...
                                       <asp:TemplateField HeaderText="Vehicle Sales Amount">
                                            <ItemTemplate>
                                                <asp:Label ID="lblvehiclesale" runat="server"  text='<%# Eval("Mv_Rate") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
