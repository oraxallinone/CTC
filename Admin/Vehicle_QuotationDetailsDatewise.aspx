<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Vehicle_QuotationDetailsDatewise.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
...
<fieldset id="FS_IssuedBook" runat="server">
                    <legend>
                        <h4>
                            Vehicle Quotation List Datewise</h4>
                    </legend>
                            ...
                            <td align="center" valign="top" colspan="7">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Model Sino">
                                            <ItemTemplate>
                                                <asp:Label ID="lblmsino" runat="server" Text='<%# Eval("Vq_Id") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Quotation Code">
                                            <ItemTemplate>
                                                <asp:Label ID="lblccode" runat="server" Text='<%# Eval("Vq_code") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lbldate" runat="server" 
                                                    Text='<%# Eval("Vq_Date","{0:dd/MM/yyyy}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Party Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblpartyname" runat="server" 
                                                    text='<%# Eval("Vq_PartyName") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                        ...
                                        <ItemTemplate>
                                          <asp:Label ID="lbladdress" runat="server" 
                                                    text='<%# Eval("Vq_Address") %>'></asp:Label>
                                                    </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                        ...
                                        <asp:TemplateField HeaderText="Phoneno">
                                            <ItemTemplate>
                                                <asp:Label ID="lblphone" runat="server"  text='<%# Eval("Vq_Phone") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="View" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgbtnview" runat="server" ToolTip='<%# Eval("Vq_Id") %>'
                                        ...
                                        <asp:TemplateField HeaderText="Edit">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgbtnedit" runat="server" ToolTip='<%# Eval("Vq_Id") %>'
                                        ...
                                        <asp:TemplateField HeaderText="Delete" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgbtndelete" runat="server" ToolTip='<%# Eval("Vq_Id") %>'
                                ...
                                <asp:TemplateField HeaderText="Print">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtn_print" runat="server" ImageUrl="~/Admin/Images/file-print.png"
                                            OnClick="imgbtn_print_Click" ToolTip='<%# Eval("Vq_Id") %>' 
                                            CommandArgument='<%# Eval("Vq_Id") %>' Height="20px" />
                                    </ItemTemplate>
