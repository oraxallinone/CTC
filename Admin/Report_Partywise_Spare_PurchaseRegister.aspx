<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Report_Partywise_Spare_PurchaseRegister.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
   ...
   <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>--%>
                <fieldset id="FS_IssuedBook" runat="server">
                    <legend>
                        <h4>
                            Party Wise Spare Purchase List
                            </h4>
                    </legend>
                    <table width="100%">
                        <tr>
                        ...
                        <tr>
                            <td align="center" valign="top">
                                ...
                                <asp:Label ID="lbl_InvoiceType" runat="server" Font-Bold="True" 
                                    Font-Names="Cambria" Font-Size="16px">PARTYWISE SPARE PURCHASE DETAILS</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" valign="top">
