<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Service_JobEntry_List.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="SlNo">
                                         ...
                                         <asp:TemplateField HeaderText="Jobcard No">
                                            <ItemTemplate>
                                                <asp:Label ID="lbljobcardno" runat="server" 
                                        ...
                                        <asp:TemplateField HeaderText="Year">
                                            <ItemTemplate>
                                                <asp:Label ID="lbljobyear" runat="server" 
                                                    text='<%# Eval("JC_year") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" width="10%"/>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Job Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lblestno" runat="server" Text='<%# Eval("JC_Date","{0:dd:MM:yyyy}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                        ...
                                        <asp:TemplateField HeaderText="Delete" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgbtndelete" runat="server" ToolTip='<%# Eval("JC_No") %>'
                                                CommandArgument='<%# Eval("JC_year") %>'     ImageUrl="~/Admin/Images/Delete_Icon.png" Width="25px" onclick="imgbtndelete_Click" 
                                                    />
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
