<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Vehicle_SalesListDatewise.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="View" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgbtnview" runat="server" ToolTip='<%# Eval("Vs_Billno") %>'
                                      ...
                                      <asp:TemplateField HeaderText="Edit" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgbtnedit" runat="server" ToolTip='<%# Eval("Vs_Billno") %>'
                                                    ImageUrl="~/Admin/Images/edit-icon.png" Width="25px" onclick="imgbtnedit_Click" />
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Delete" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgbtndelete" runat="server" ToolTip='<%# Eval("Vs_Billno") %>'
                                ...
                                <asp:TemplateField HeaderText="Print">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtn_print" runat="server" ImageUrl="~/Admin/Images/file-print.png"
                                            OnClick="imgbtn_print_Click" ToolTip='<%# Eval("Vs_Billno") %>' 
                                            CommandArgument='<%# Eval("Vs_Billno") %>' Height="20px" />
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Width="40px" />
                                    <ItemStyle HorizontalAlign="Center" Width="40px" />
                                </asp:TemplateField>
