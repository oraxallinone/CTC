<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Report_Partywise_Spare_SalesRegister.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
  ...
  <%--  <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>--%>
                <fieldset id="FS_IssuedBook" runat="server">
                    <legend>
                        <h4>
                            Customer WiseSpare Sales List</h4>
                    </legend>
                    <table width="100%">
                        <tr>
                            <td style="width: 16%">
                            ...
                            <td style="width: 1%">
                                :</td>
                            <td style="width: 24%">
                                <asp:DropDownList ID="ddlcustomer" runat="server" Width="170px">
                                </asp:DropDownList>
                            </td>
                            <td>
                                &nbsp;</td>
                        ...
                        <tr>
                            <td align="center" valign="top">
                                ...
                                <asp:Label ID="lbl_InvoiceType" runat="server" Font-Bold="True" 
                                    Font-Names="Cambria" Font-Size="16px">PARTY WISE SPARE SALE</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" valign="top">
