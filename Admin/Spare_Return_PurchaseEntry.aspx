<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Spare_Return_PurchaseEntry.aspx.cs" Inherits="Admin_Spare_PurchaseEntry123" %>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <strong>:</strong></td>
                            <td>
                                <asp:TextBox ID="txt_BReturnDate" runat="server" CssClass="TextBoxGraiantDate" 
                                    Height="25px" Width="150px"></asp:TextBox>
                                <asp:CalendarExtender ID="txt_BReturnDate_CalendarExtender" runat="server" 
                                    CssClass="red" Enabled="True" Format="dd/MM/yyyy" 
                                    TargetControlID="txt_BReturnDate">
                                </asp:CalendarExtender>
                            </td>
                            <td>
                                Recieving Date
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txt_PartNo" runat="server" CssClass="TextBoxGraiant" Width="150px"
                                                Height="25px" OnTextChanged="txt_PartNo_TextChanged" AutoPostBack="True" 
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt_PartDesc" runat="server" CssClass="TextBoxGraiant" Height="25px"
                                                Width="150px" OnTextChanged="txt_PartDesc_TextChanged" AutoPostBack="True" 
                                                Enabled="False"></asp:TextBox>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt_PartQuantity" runat="server" CssClass="TextBoxGraiant" Height="25px"
                                                Width="70px" onkeypress="return AllowDecimalNumbersOnly(this,event)" 
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt_AvlQty" runat="server" CssClass="TextBoxGraiant" 
                                                Enabled="False" Font-Bold="True" ForeColor="#FF0066" Height="25px" 
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt_PartVat" runat="server" CssClass="TextBoxGraiant" Height="25px"
                                                Width="60px" onkeypress="return AllowDecimalNumbersOnly(this,event)"></asp:TextBox>
                                        </td>
                                        <td>
                                        ...
                                        <td align="center">
                                            <asp:Button ID="btn_PartAdd" runat="server" CssClass="VerySmallYellow" Height="28px"
                                                Text="Save" Width="60px" OnClick="btn_PartAdd_Click" Visible="False" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td colspan="6">
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CssClass="mGrid" Width="100%">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Return Stock">
                                            <ItemTemplate>
                                                <asp:Button ID="btnreturn" runat="server" CssClass="ThinRed" 
                                                    onclick="btnreturn_Click" Text="Return" ToolTip='<%# Eval("Itm_Partno") %>' CommandArgument='<%# Eval("Ss_Id") %>' 
                                                    Width="100%" />
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="70px" />
                                            <ItemStyle HorizontalAlign="Left" Width="70px" />
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:Button ID="btn_Cancel" runat="server" CssClass="VerySmallRed" Height="26px"
                                    ...
                                    PostBackUrl="~/Admin/Spare_Return_PurchaseEntryList.aspx" />
                            </td>
                            <td>
                                &nbsp;
                            </td>
