...
using System.Text;
using System.IO;
public partial class Admin_Report_CounterSale1 : System.Web.UI.Page
{
    ...
    public void FillGrid()
    {
        try
        {
            ...
            DataTable dtr = smitaDbAccess.SPReturnDataTable("sp_CounterSale_WithReturn_Reportgst", param, paramvalue);
            if (dtr.Rows.Count > 0)
            {
