<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Spare_SalesPrint.aspx.cs" Inherits="Admin_Vehicle_SalesInvoicePrint" %>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="TaxableAmount">
                          ...
                          <asp:TemplateField HeaderText="SGst">
                                            <ItemTemplate>
                                                <asp:Label ID="LabelSGst" runat="server" Text='<%# Eval("Ss_SGst") %>'></asp:Label><br />
                                        ...
                                        <asp:TemplateField HeaderText="CGst">
                                            <ItemTemplate>
                                                <asp:Label ID="Labelcgst" runat="server" Text='<%# Eval("Ss_CGst") %>'></asp:Label><br />
                                        ...
                                        <asp:TemplateField HeaderText="IGst">
                                            <ItemTemplate>
                                                <asp:Label ID="Labeligst" runat="server" Text='<%# Eval("Ss_IGst") %>'></asp:Label><br/>
