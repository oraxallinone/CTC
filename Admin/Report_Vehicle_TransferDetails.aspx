<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Report_Vehicle_TransferDetails.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
...
<fieldset id="FS_IssuedBook" runat="server">
                    <legend>
                        <h4>
                            Vehicle Stock Transfer Details</h4>
                    </legend>
                         ...
                         <tr>
                             <td align="center" colspan="7" valign="top">
                                 ...
                                 <asp:Label ID="lbl_InvoiceType" runat="server" Font-Bold="True" 
                                     Font-Names="Cambria" Font-Size="16px">VEHICL STOCK TRANSFER LIST</asp:Label>
                             </td>
                         </tr>
                         <tr>
                             <td align="center" colspan="7" valign="top">
                                ...
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                      ...
                                      <asp:TemplateField HeaderText="Transfer Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lbltobranch" runat="server" Text='<%# Eval("St_Transferdate","{0:dd/MM/yyyy}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                                        </asp:TemplateField>
