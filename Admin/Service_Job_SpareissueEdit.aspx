<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Service_Job_SpareissueEdit.aspx.cs" Inherits="Admin_Spare_PurchaseEntry" %>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="width: 30%">
                                <asp:TextBox ID="txt_jcno" runat="server" CssClass="TextBoxGraiant" 
                                    ...
                                    Height="25px" Width="100px"  ReadOnly="true"
                                    ></asp:TextBox>
                            </td>
                            <td colspan="2" style="width: 15%">
                                &nbsp;</td>
                                    ...
                                    <tr>
                                        <td>
                                         ...
                                         <td style=" position:relative">
                                            <asp:TextBox ID="txt_partid" runat="server" CssClass="TextBoxGraiant" 
                                                 Height="25px" Width="100px" AutoPostBack="True" 
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt_PartDesc" runat="server" 
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt_PartQuantity" runat="server" CssClass="TextBoxGraiant" 
                                                ...
                                                onkeypress="return AllowDecimalNumbersOnly(this,event)" Width="80px"></asp:TextBox>
                                        </td>
                                        <td>
                                        ...
                                        <td align="center">
                                            <asp:Button ID="btn_PartAdd" runat="server" CssClass="VerySmallYellow" 
                                                Height="28px" OnClick="btn_PartAdd_Click" Text="Add" Width="40px" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Total">
                                          ...
                                          <asp:TemplateField HeaderText="Edit">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgbtn_edit" runat="server" Height="18px" 
                                                    ImageUrl="~/Admin/Images/edit-icon.png" 
                                                    ToolTip='<%# Eval("SE_Id") %>' onclick="imgbtn_edit_Click1" />
                                            </ItemTemplate>
