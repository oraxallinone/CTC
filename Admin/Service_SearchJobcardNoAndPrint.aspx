<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Service_SearchJobcardNoAndPrint.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
...
<fieldset id="FS_IssuedBook" runat="server">
                    ...
                    <td style="width: 24%">
                        <asp:TextBox ID="txt_sino" runat="server" ></asp:TextBox>
                             ...
                             <td>
                        <asp:TextBox ID="txt_year"  runat="server" Width="70px" ></asp:TextBox>
