...
public partial class Admin_Form21 : System.Web.UI.Page
{
    ...
    public void fillservice()
    {
        ...
        var v = (from c in db.AME_Service_JobCardEntry
                 ...
                 where c.JC_year == year && c.JC_No == sno && c.Branch_Name == branchname && c.Ms_Status != "STOP" && c.Ms_Status == "OPEN"
                 &&  g.Jc_year==year
    ...
    public void fillbill()
    {
        try
        {
            ...
            var v = (from c in db.AME_Service_JobCardEntry
                     ...
                     where c.JC_No == sino && c.Branch_Name == branchname && c.Ms_Status == "OPEN" && c.JC_year == year
                     select new
