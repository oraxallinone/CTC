<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Report_CustomerwiseSpare_SalesRegister.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
                ...
                <fieldset id="FS_IssuedBook" runat="server">
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td class="style3">
                                <asp:DropDownList ID="ddl_customer" runat="server" Width="150px">
                                </asp:DropDownList>
                            </td>
                            <td class="style4">
                            </td>
                        ...
                        <tr>
                            <td align="center" valign="top">
                                ...
                                <asp:Label ID="lbl_InvoiceType" runat="server" Font-Bold="True" 
                                    Font-Names="Cambria" Font-Size="16px">Customer Wise Sales List</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" valign="top">
