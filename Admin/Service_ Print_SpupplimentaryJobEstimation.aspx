<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Service_ Print_SpupplimentaryJobEstimation.aspx.cs" Inherits="Admin_ServiceEstimation" %>
...
<asp:Label ID="lbl_Header" runat="server" CssClass="Header1" Text="Supplimentary Estimation Report">
</asp:Label>
 <fieldset>
        <legend>
            <h5>
                Print Supplimentary Estimate Report</h5>
        </legend>
       <br /> 
        &nbsp;<center>
        ...
        <td colspan="14" align="left">
            ...
            Odisha, Ph-9876543210<br /> &nbsp;<a 
                href="mailto:E-mail-rashmimotors.lcv@rashmigroups.com">E-mail-</a><br /> </td>
           
        </tr>
        <tr runat="server" id="tr_bam">
        <td colspan="14" align="left">
            <br />
            ...
            <br />
            Odisha, Ph-<br /> &nbsp;<a 
                href="mailto:E-mail-rashmimotors.lcv@rashmigroups.com">E-</a><br /> </td>
           
        </tr>
        <tr runat="server" id="tr_anu">
        <td colspan="14" align="left">
            <br />
