<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Spare_ReturnSalesEntryView.aspx.cs" Inherits="Admin_Spare_PurchaseEntry" %>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td align="left" valign="top">
                                <asp:TextBox ID="txt_BName" runat="server" CssClass="TextBoxGraiant" 
                                    Height="25px" ontextchanged="txt_BName_TextChanged" Width="200px"></asp:TextBox>
                                ...
                                <table class="skin-3" style="border-style: dashed; border-width: thin; border-color: #000000;
                                    ...
                                    Enabled="false"    Height="25px" OnTextChanged="txt_PartNo_TextChanged" AutoPostBack="True"></asp:TextBox>
                                        ...
                                        <td>
                                            ...
                                            onkeypress="return AllowDecimalNumbersOnly(this,event)"       Width="70px" ontextchanged="txt_RetrnQty_TextChanged">0</asp:TextBox>
                                        </td>
                                        <td>
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="style2">
                                ...
                                OnClientClick="return validationfields1();"      Text="Update" Width="120px" onclick="btn_Submit_Click" />
                            </td>
