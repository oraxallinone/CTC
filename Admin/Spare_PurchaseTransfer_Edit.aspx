<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Spare_PurchaseTransfer_Edit.aspx.cs" Inherits="Admin_Spare_PurchaseTransfer_Edit" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
         $(document).ready(function () {
             ...
             $("#ContentPlaceHolder1_txt_PartNo").on("change", function (e) {
                 e.preventDefault();
                 var aData = [];
                 aData[0] = $("#ContentPlaceHolder1_txt_PartNo").val();
                 $("#ContentPlaceHolder1_txt_PartDesc").empty();
                 $("#ContentPlaceHolder1_txt_avlquantity").empty();
                 $("#ContentPlaceHolder1_txt_rate").empty();
                 var jsonData = JSON.stringify({ aData: aData });
                 $.ajax({
                     type: "POST",
                     //getListOfCars is my webmethod   
                     url: "Spare_PurchaseTransfer.aspx/GetCustomers",
                     data: jsonData,
                 ...
                 function OnSuccess(response) {
                     document.getElementById('ContentPlaceHolder1_txt_PartDesc').value = data.PartDes;
                     document.getElementById('ContentPlaceHolder1_txt_avlquantity').value = data.SalePrice;
                     document.getElementById('ContentPlaceHolder1_txt_rate').value = data.VatPercent;
                 }
                        ...
                        <tr>
                            ...
                            <td style="width: 30%">
                                <asp:TextBox ID="txt_BVoucherNo" runat="server" CssClass="TextBoxGraiant" Height="25px"
                                    Width="200px" AutoPostBack="True" onkeypress="return AllowDecimalNumbersOnly(this,event)"
                                    ontextchanged="txt_BVoucherNo_TextChanged"></asp:TextBox>
                            </td>
                            <td style="width: 15%">
                                Invoice Number
                            </td>
