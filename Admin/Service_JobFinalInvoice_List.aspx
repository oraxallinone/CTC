<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Service_JobFinalInvoice_List.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
                                    ...
                                    <Columns>
                                       ...
                                       <asp:TemplateField HeaderText="Invoice Amount">
                                        ...
                                        <asp:TemplateField HeaderText="Submitted By">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_submittedby" runat="server"  text='<%# Eval("Submittedby") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                      ...
                                      <asp:TemplateField HeaderText="Print" Visible="false" >
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgbtnprint1" runat="server"  ToolTip='<%# Eval("jc_year")   %>' CommandArgument='<%# Eval("FI_Sino") %>'
                                                 Width="25px" />
