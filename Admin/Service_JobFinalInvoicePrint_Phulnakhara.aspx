<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Service_JobFinalInvoicePrint_Phulnakhara.aspx.cs" Inherits="Admin_Service_JobFinalInvoicePrint_Phulnakhara" %>
    ...
    Authorised Main Dealer Of Ashok Leyland Ltd.</td>
        ...
        <tr>
            <td align="center" colspan="9">
                N.H-5, Phulnakhara, Cuttack</td>
        </tr>
        <tr>
            <td align="center" colspan="9">
                E-mail :, Mobile-7752049561</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="left" colspan="2" 
                ...
                style="border-bottom: thin dotted #000000; color: #000000; font-weight: bold; font-size: medium; width: 20%;">
                &nbsp;</td>
            <td align="left" colspan="2" 
                style="border-bottom-style: dashed; border-bottom-width: thin; border-bottom-color: #000000;" 
                width="10%">
        ...
        <tr>
         ...
         <tr>
            ...
            <td align="left" width="2%">
                :</td>
            <td align="left" colspan="3" width="30%">
                 <asp:Label ID="lbl_tin" runat="server"></asp:Label>
            </td>
            <td align="left" width="15%" >
               </td>
            <td align="left" width="2%">
           ...
           <asp:TemplateField HeaderText="HSN CODE">
            ...
            <asp:TemplateField HeaderText="TaxableAmount">
             ...
             <asp:TemplateField HeaderText="SGst">
                <ItemTemplate>
                    <asp:Label ID="Label16" runat="server" Text='<%# Eval("SE_Sgst") %>'></asp:Label>
      ...
      <tr>
        ...
        <%--<tr>
            <td align="right" colspan="4">
                &nbsp;</td>
            <td align="left" colspan="2">
               GSTONSERVICE @<asp:Label ID="lblservtaxp" runat="server" Text="18"></asp:Label>
                &nbsp;%</td>
            <td align="right" colspan="2">
