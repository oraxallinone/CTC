<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Spare_StockAdjustment.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
                                        ...
                                        <Columns>
                                          <asp:TemplateField HeaderText="Sl. No.">
                                            ...
                                            <asp:TemplateField HeaderText="Invoice No">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblinvoiceno" runat="server" 
                                                        Text='<%# Eval("Sp_VoucherNo") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Itm PartDescrption">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblpartdescrp" runat="server" text='<%# Eval("Itm_PartDescrption") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Quantity">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblquantity" runat="server" 
                                                        Text='<%# Eval("Ss_Quantity") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" width="80px"  />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Net Quantity">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblnetquantity" runat="server" text='<%# Eval("Ss_NetQuantity") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                                            </asp:TemplateField>
                                               <asp:TemplateField HeaderText="Adjust Quantity">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txt_adjustquntity" onkeypress="return AllowDecimalNumbersOnly(this,event)" runat="server" Width="90px"></asp:TextBox>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Total Amount">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbltotalamount" runat="server" Text='<%# Eval("Ss_Total") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                                            </asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgbtnedit" runat="server" 
                                                    ...
                                                    ToolTip='<%# Eval("Ss_Id") %>' Height="20px" 
                                                    onclick="imgbtnedit_Click"   />
                                                <asp:ImageButton ID="imgbtnupadte" runat="server" Height="20px" ToolTip='<%# Eval("Ss_Id") %>'
