<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="ItemPartTrack.aspx.cs" Inherits="Admin_ItemPartTrack" %>
                    ...
                    <table width="100%">
                        <tr>
                            <td align="center" valign="top">
                                ...
                                <asp:Label ID="lbl_InvoiceType" runat="server" Font-Bold="True" 
                                    Font-Names="Cambria" Font-Size="16px">Item Track Report</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" valign="top">
                        ...
                        <tr>
                            <td align="center" valign="top" style="position:relative">
                                 Part Name:<asp:TextBox ID="txt_PartNo" runat="server" 
                            ...
                            <td align="center" valign="top">
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="BillNo/InvoiceNo">
                                            <ItemTemplate>
