...
public partial class Report_ProjectExpensesDetailsCodeDatewise : System.Web.UI.Page
{
    ...
    public void FillGrid()
    {
        try
        {
            ...
            DataTable dtr = smitaDbAccess.SPReturnDataTable("sp_DailySpareSales_WithReturn_Report1", param, paramvalue);
            if (dtr.Rows.Count > 0)
            {
                ...
                foreach (GridViewRow gr in GridView1.Rows)
                {
                  ...
                  //  lbloutput5.Text = Convert.ToDouble(tot25 * 0.145).ToString("0.00");
                    ...
                    tot32 = tot32 + (tot24 + tot25 + tot34 + tot35 + tot30 + tot31);
                   ...
                   // tot23 = Convert.ToDecimal( tot23 + lbloutput5.Text;
                    ...
                    lbl_fgamnt.Text = Math.Round(tot32).ToString();
