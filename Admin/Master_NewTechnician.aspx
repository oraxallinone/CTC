<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Master_NewTechnician.aspx.cs" Inherits="Admin_CreateUser" %>
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td align="left" width="30%">
                                <asp:TextBox ID="txt_Name" runat="server" CssClass="SmalldottedTextBox" 
                                    Width="250px"></asp:TextBox>
                            </td>
                            <td class="style1">
                                <strong>Technician List</strong></td>
                        </tr>
                        <tr>
                            ...
                            <td align="left" width="30%" height="25px" valign="top">
                                <asp:TextBox ID="txt_MobileNo" runat="server" CssClass="SmalldottedTextBox" 
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Technician Name">
                                            <ItemTemplate>
                                                <asp:Label ID="Label3" runat="server" Text='<%# Eval("Mt_Name") %>'></asp:Label>
                                            </ItemTemplate>
