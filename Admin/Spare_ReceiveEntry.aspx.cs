...
public partial class Admin_Spare_ReceiveEntry : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            txt_BchallanDate.Text = DateTime.Now.ToString("dd/MM/yyyy");
        }
    }
    ...
    private void FillVoucherNo()
    {
        ...
        if ((from c in db.AME_Spare_ReceiveEntryBillDetails where c.Branch_Name == branchname select c.Sp_VoucherNo).Count() > 0)
        {
            int VNo = (int)(from c in db.AME_Spare_ReceiveEntryBillDetails where c.Branch_Name == branchname select c.Sp_VoucherNo).Max();
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        ...
        AME_Spare_ReceiveEntryBillDetails pd = new AME_Spare_ReceiveEntryBillDetails();
        ...
        db.AddToAME_Spare_ReceiveEntryBillDetails(pd);
        db.SaveChanges();
        ...
        ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "MessagePopUp", "<script language='JavaScript'>alert('Receive Entry done SuccessFully..!!'); </script>", false);
        cl.Clear_All(this);
        FillSupplier();
        FillVoucherNo();
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            decimal afterdisc = (amnt - descamnt);
            decimal tax = 18;
            txt_PartTaxAmount.Text = (afterdisc * tax / 100).ToString("0.00");
            decimal aftertax = Convert.ToDecimal(txt_PartTaxAmount.Text);
            txt_PartTotal.Text = (afterdisc + aftertax).ToString("0.00");
        }
    }
