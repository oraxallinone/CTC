<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Report_Spare_StockTransferAdd.aspx.cs" Inherits="Admin_Report_Spare_StockTransferAdd" %>
                        ...
                        <tr>
                            <td align="center" valign="top">
                                ...
                                <asp:Label ID="lbl_InvoiceType" runat="server" Font-Bold="True" 
                                    Font-Names="Cambria" Font-Size="16px">Spare Stock Added List</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" valign="top">
