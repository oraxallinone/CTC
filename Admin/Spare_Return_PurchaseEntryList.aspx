<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Spare_Return_PurchaseEntryList.aspx.cs" Inherits="admin_StockMaster" %>
        ...
        <ContentTemplate>
            ...
            <tr>
                ...
                Finacial Year
                    ...
                    <td style="width: 24%">
                        <asp:TextBox ID="txt_year" runat="server"  Width="160px"></asp:TextBox>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Return">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Admin/Images/brackets_icon.png"
                                            OnClick="ImageButton2_Click" ToolTip='<%# Eval("Sp_Id") %>' Height="16px" 
                                           CommandArgument='<%# Eval("Sp_VoucherNo") %>' Enabled="true"/>
                                    </ItemTemplate>
