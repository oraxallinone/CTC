<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="VehicleSale_Modify.aspx.cs" Inherits="Admin_VehicleSale_Modify" %>
                    ...
                    <table id="tbl_details" runat="server" style="width: 100% ; ">
                        ...
                        <tr>
                            <td colspan="6" align="center">
                                &nbsp;
                                <asp:Button ID="btn_update" runat="server" CssClass="btn-info" Font-Bold="True" 
                                    Font-Names="US"  Text="Update Bill" onclick="btn_update_Click" />
                            </td>
                        </tr>
                    </table>
                </fieldset>
