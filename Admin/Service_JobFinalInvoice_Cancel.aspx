<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Service_JobFinalInvoice_Cancel.aspx.cs" Inherits="Report_ProjectExpensesDetailsCodeDatewise" %>
                                       ...
                                       <asp:TemplateField HeaderText="Cancel" >
                                            <ItemTemplate>
                                                <asp:Button ID="btncancel" runat="server" Text="Cancel" 
                                                    ToolTip='<%# Eval("FI_JcNo") %>' 
                                                    CssClass="ThinRed" onclick="btncancel_Click" />
