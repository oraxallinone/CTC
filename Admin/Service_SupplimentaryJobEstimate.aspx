<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Service_SupplimentaryJobEstimate.aspx.cs" Inherits="Admin_Spare_PurchaseEntry" %>
            ...
            <asp:Panel ID="Panel1" runat="server">
                <div id="content" style="background-color: #FFFFFF; padding-left: 15px; padding-right: 10px;">
                    <fieldset style="padding-right: 20px;">
                        <legend>
                            <h3>
                                Supplimentary job Estimate</h3>
                        </legend>
                        <div style="text-align:center" width="100%">
                         Enter estimation No<asp:DropDownList ID="ddlestimationno" runat="server">
                            </asp:DropDownList>
                           

                            &nbsp;<asp:Button ID="btn_serch" runat="server" CssClass="VerySmallLiteBlue" 
                                onclick="btn_serch_Click" Text="Search" />
                        </div>
                        <table style="width: 100%;" runat="server" id="tbl_details">
                            <tr>
                                <td style="width: 15%">
                                    &nbsp;</td>
                                <td style="width: 1%">
                            ...
                            <tr>
                                <td style="width: 15%">
                                    Supplimentary Estimate No
                                </td>
                                <td style="width: 1%">
                                    <strong>:</strong>
                                </td>
                                <td style="width: 30%">
                                    <asp:TextBox ID="txt_BEstimateNo" runat="server" CssClass="TextBoxGraiant" 
                            ...
                            <tr>
                                <td>
                                    Supplimentary Estimation Date</td>
                                <td>
                                    &nbsp; :</td>
                                <td>
                                    <asp:TextBox ID="txt_sedate" runat="server" CssClass="TextBoxGraiantDate" 
                                        Height="25px" Width="150px"></asp:TextBox>
                                    <asp:CalendarExtender ID="txt_sedate_CalendarExtender" runat="server" 
                                        CssClass="red" Enabled="True" Format="dd/MM/yyyy" 
                                        TargetControlID="txt_sedate">
                                    </asp:CalendarExtender>
                                </td>
                                <td>
                                    &nbsp;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txt_PartDiscount" runat="server" CssClass="TextBoxGraiant" Height="25px"
                                                    Width="80px" onkeypress="return AllowDecimalNumbersOnly(this,event)"
                                                ontextchanged="txt_disc_TextChanged" AutoPostBack="True">0</asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txt_PartVat" runat="server" CssClass="TextBoxGraiant" Height="25px" ReadOnly="True"
                                                    Width="80px" onkeypress="return AllowDecimalNumbersOnly(this,event)"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txt_PartTaxAmount" runat="server" CssClass="TextBoxGraiant" Height="25px"
                                                 ReadOnly="True"   Width="80px" onkeypress="return AllowDecimalNumbersOnly(this,event)"></asp:TextBox>
                                            </td>
                                            <td>
                                           ...
                                           <asp:AutoCompleteExtender ID="txt_SCode_AutoCompleteExtender" runat="server" CompletionListCssClass="AutoExtender"
                                            ...
                                            <td>
                                                <asp:TextBox ID="txt_SQuantity" runat="server" CssClass="SmalldottedTextBox" onkeypress="return AllowNumbersOnly(this,event)"
                                                    Width="100px"   onkeyup="totalamnt()"></asp:TextBox>
                                            </td>
                                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Discount
                                    <asp:TextBox ID="txt_ALabDiscountPer" runat="server" CssClass="TextBoxGraiant" Height="25px" onkeyup="labourdisc()"
                                        onkeypress="return AllowDecimalNumbersOnly(this,event)" Width="40px" 
                                        ontextchanged="txt_ALabDiscountPer_TextChanged">0</asp:TextBox>
                                    &nbsp;%
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="txt_AServiceTaxPer" runat="server" CssClass="TextBoxGraiant" Height="25px"
                                        onkeypress="return AllowDecimalNumbersOnly(this,event)" Width="40px">18.00</asp:TextBox>
                                    &nbsp;%
                                </td>
                                <td>
                            ...
                            <tr>
                                <td align="center" colspan="7">
                                    &nbsp; &nbsp;&nbsp;<asp:Button ID="btn_Submit" runat="server" 
                                        CssClass="VerySmallGreen" Height="26px" OnClick="btn_Submit_Click" 
                                        Text="Add Supplimentary" Width="100px" />
                                    &nbsp;
