<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Print_JobEstimation.aspx.cs" Inherits="Admin_ServiceEstimation" %>
...
<asp:Label ID="lbl_Header" runat="server" CssClass="Header1" Text="Estimation Report">
</asp:Label>
 <fieldset style="text-transform:uppercase;">
        <legend>
            <h5>
                Print Estimate Report</h5>
        </legend>
       <br /> 
        &nbsp;<center>
        ...
        <tr>
        <td id="td_esti" runat="server" colspan="14" style="text-align:left" visible="false">
           
            <asp:Label ID="Label8" runat="server" Font-Bold="True" Text="RASHMI MOTORS"></asp:Label>
            <br />
            N.H-5, Manguli, Choudwar, Cuttack-754025
            <br />
            Odisha, Ph-0671-6606666<br /> 
            E-mail-<a href="mailto:E-mail-rashmimotors.lcv@rashmigroups.com" style="text-transform:lowercase;">rashmimotors.lcv@rashmigroups.com</a>
            <br /> 
               
                </td>
           
        <td id="td_phul" runat="server" colspan="14" style="text-align:left" visible="false">
           
            <asp:Label ID="Label2" runat="server" Font-Bold="True" Text="RASHMI MOTORS"></asp:Label>
            <br />
            N.H-5, Phulnakhara, Cuttack
            <br />
            Odisha, Mob-9876543210<br />
            E-mail-<a href="#" style="text-transform:lowercase;"></a>
            <br /> 
               
                </td>
        <td id="td_anugul" runat="server" colspan="14" style="text-align:left" visible="false">
           
            <asp:Label ID="Label9" runat="server" Font-Bold="True" Text="RASHMI MOTORS"></asp:Label>
            <br />
            AUTHORISED MAIN DEALER OF ASHOK LEYLAND LTD.
            <br />
           AT-KATHAGADA,PO-BHUTUMUNDAI,PARADEEP,DIST-JAGATSINGHPUR
            <br />
            Odisha, Mob-8093094464<br />
            E-mail-<a href="mailto:E-mail-rashmimotors.angul@rashmigroups.com" style="text-transform:lowercase;">rashmimotors.angul@rashmigroups.com</a>
            <br /> 
               
                </td>
        <td id="td_bam" runat="server" colspan="14" style="text-align:left" visible="false">
            ...
            <br />
            Odisha, Ph-<br /> 
            E-mail-<a href="mailto:E-mail-" style="text-transform:lowercase;"></a>
            <br /> 
            ...
            <tr>
                <td colspan="2" 
                    style="border-top-width: thin; border-color: #000000; border-top-style: groove; text-align:left" 
                    width="16%">
                    Party Name</td>
                <td colspan="3" 
                    style="border-top-width: thin; border-color: #000000; border-top-style: groove;text-align:left" 
            ...
            <tr>
                <td colspan="2" style="text-align:left">
                    Address</td>
                <td colspan="3" width="40%" style="text-align:left">
            ...
            <tr>
                <td colspan="14" 
                    ...
                    style="border-top-style: dotted; border-top-width: thin;
                     border-top-color: #000000; font-family: 'Cambria'; text-transform:uppercase;">
            ...
            <tr>
                <td colspan="14" 
                    ...
                    style="border-top-style: dotted; border-top-width: thin; border-top-color: #000000;
                     font-family: 'Bookman Old Style'; text-transform:uppercase;">
            ...
            <tr>
              ...
              <tr>
                <td align="right" colspan="14" 
                    ...
                    style="border-width: medium; border-color: #000000; font-family: 'Bookman Old Style'; 
                    border-top-style: dotted; text-transform:uppercase;">
                    Spare Gross Amount<asp:Label ID="lblgross" runat="server" 
                        Height="23px" Width="100px"></asp:Label>
                    </td>
            </tr>
            <tr>
                <td align="right" class="style2" colspan="14" 
                    style="font-family: 'Bookman Old Style'; text-transform:uppercase;">
                    Discount
            ...
            <tr>
             ...
             <tr>
                <td align="right" colspan="14" style="font-family: 'Bookman Old Style'; text-transform:uppercase;">
                  Gst Amount
            ...
            <%--<tr>
                <td align="right" colspan="14" style="font-family: 'Bookman Old Style'; text-transform:uppercase;">
                    Disc. %&nbsp;&nbsp;
                    <asp:Label ID="lbl_tdiscper" runat="server" Height="23px" Width="100px"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="right" colspan="14" style="font-family: 'Bookman Old Style'; text-transform:uppercase;">
                    Total Disc. Amount&nbsp;&nbsp;
                    <asp:Label ID="lbl_tdisc" runat="server" Height="23px" Width="100px"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="right" colspan="14" style="font-family: 'Bookman Old Style'; text-transform:uppercase;">
                    Total Spare Amount&nbsp;&nbsp;
                    <asp:Label ID="lbl_Gspareamount" runat="server" Height="23px" Width="100px"></asp:Label>
                </td>
            </tr>--%>
            <tr>
                <td align="right" colspan="14" style="font-family: 'Bookman Old Style'; text-transform:uppercase;">
            ...
            <tr>
                <td align="right" colspan="7">
                    &nbsp;</td>
                <td align="right" colspan="7" 
                    style="border-width: thin; border-color: #000000; border-top-style: groove;
                     font-family: 'Bookman Old Style'; text-transform:uppercase;" 
                    width="30%">
            ...
            <tr>
                ...
                <td align="right" colspan="7" 
                    style="font-weight: bold; font-family: 'Bookman Old Style'; text-transform:uppercase;" width="30%">
            ...
            <tr>
                <td align="left" class="style1" colspan="14" 
                    style="font-weight: bold; text-decoration: underline; text-transform:uppercase;">
                    Terms and Conditions:</td>
            </tr>
            <tr>
                <td align="left" class="style1" colspan="14" style=" text-transform:uppercase;">
            ...
            <tr>
                <td align="left" colspan="14" style="font-weight: bold; color: #000000; text-transform:uppercase;">
            ...
            <tr>
                <td align="left" colspan="14" style=" text-transform:uppercase;">
