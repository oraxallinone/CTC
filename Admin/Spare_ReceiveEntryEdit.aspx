<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Spare_ReceiveEntryEdit.aspx.cs" Inherits="Admin_Spare_ReceiveEntryEdit" %>
                ...
                <fieldset style="padding-right: 20px;">
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txt_BchallanNo" runat="server" CssClass="TextBoxGraiant" Height="25px"
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <td style="position:relative">
                                <asp:TextBox ID="txt_BchallanDate" runat="server" CssClass="TextBoxGraiantDate" Height="25px"
                                    Width="150px"></asp:TextBox>
                                <asp:CalendarExtender ID="txt_BchallanDate_CalendarExtender" runat="server" CssClass="red"
                                    Enabled="True" Format="dd/MM/yyyy" TargetControlID="txt_BchallanDate">
                                </asp:CalendarExtender>
                            </td>  
                             <td>
                                &nbsp;</td>
